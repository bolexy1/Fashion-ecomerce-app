...
import 'package:t_store/features/shop/screens/product_reviews/widget/progress_indicator_and_rating.dart';
...
class BOverallProductRating extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        Expanded( flex: 3, child: Text('4', style: Theme.of(context).textTheme.displayLarge,)),
        const Expanded(
          flex: 7,
          child: Column(
            children: [
